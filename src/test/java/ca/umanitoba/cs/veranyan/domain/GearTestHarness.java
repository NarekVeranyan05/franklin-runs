...
public class GearTestHarness {
    ...
    public void testTypes(){
        var arr = new ArrayList<String>(List.of("ROAD_BIKE", "MOUNTAIN_BIKE", "COMMUTER_BIKE", "ELECTRIC_BIKE", "TANDEM_BIKE"));

        try{
            for(var name : arr) {
                GearType.fromString(name);
            }

            pass("Converted all types successfully");
        } catch (InvalidGearTypeException e) {
            fail("Did not convert gear type name appropriately");
        }
    }
